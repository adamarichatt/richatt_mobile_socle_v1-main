...
import 'package:Remeet/features/richatt/screens/home/widgets/FavoriteProfessionalsPage.dart';
import 'package:Remeet/features/richatt/screens/home/widgets/edit_appointment_page.dart';
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          await controller.getNextAppointmentByEmail(email);
          // controller.getFavoriteProfessionals(email);
          await favoriteController.getFavoriteProfessionals(email);
        },
